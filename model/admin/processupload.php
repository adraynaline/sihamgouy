...
if(isset($_POST))
{
	...
	$DestinationDirectory	= '../../images/'; //specify upload directory ends with / (slash)
	...
	{*/
		...
		*/
		...
		echo '<tr>';
		echo '<td align="center"><img id="ok_img" src="images/'.$ThumbPrefix.$NewImageName.'" alt="Thumbnail"></td>';
		echo '</tr>';
		echo '</table>';
